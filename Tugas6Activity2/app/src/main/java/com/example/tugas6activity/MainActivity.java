package com.example.tugas6activity;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.buttonDialNumber:
                String phoneNumber = "085156474183";
            ...
            case R.id.buttonShare:
                ...
                share.putExtra(Intent.EXTRA_TEXT, "SEMANGAT!!!");
                share.setType("text/plain");
                startActivity(Intent.createChooser(share, "share link"));
                break;
            case R.id.buttonSMS:
                Intent sms = new Intent(Intent.ACTION_SENDTO, Uri.parse("smsto: 085156474183"));
